...
public class IssueList extends ListActivity {
	...
	private static String url_all_issues = "http://api.androidhive.info/android_connect/get_all_products.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// launching show Issue screen on click of an Issue
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// Starting new intent
				Intent in = new Intent(getApplicationContext(), Getissue.class);
	...
	// Response from Show Issue Screen Activity
	@Override
			...
			try {
				...
				if (success == 1) {
					...
					for (int i = 0; i < issuesArray.length(); i++) {
						...
						String name = c.getString(TAG_ISSUE);
					...
					// no products found
					/*
					 * // Launch Add New product Activity Intent i = new
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					 ...
					 * */
					ListAdapter adapter = new SimpleAdapter(IssueList.this,
							issuesList, R.layout.activity_issue_list,
							new String[] { TAG_PID, TAG_ISSUE }, new int[] {
									R.id.pid, R.id.issueDesc });
